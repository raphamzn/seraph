...
private slots:
    ...
    void testUnifiedTrashRoot()
    {
        ...
        const QString fileName = "seraph-trash-model-" + QUuid::createUuid().toString(QUuid::WithoutBraces) + ".txt";
        const QString dirPath = QDir::homePath() + "/.cache/seraph-test-trash-model";
        QDir().mkpath(dirPath);
